...
async def _sender(chat_id: int, file_id: str, caption: str | None = None):
    try:
        ...
        await _sender(chat_id, file_id, caption)
...
async def send(active: bool, text: str = "⚙️ Ваше сообщение.\n\n"):
